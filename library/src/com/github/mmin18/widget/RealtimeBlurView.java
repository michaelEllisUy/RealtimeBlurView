...
public class RealtimeBlurView extends View {
    ...
    private float realtimeBorderRadius;
    ...
    private final RectF mRectSrc = new RectF(), mRectDst = new RectF();
    ...
    public RealtimeBlurView(Context context, AttributeSet attrs) {
        ...
        realtimeBorderRadius = a.getDimension(R.styleable.RealtimeBlurView_realtimeBorderRadius,
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        drawBlurredBitmap(canvas, mBlurredBitmap, mOverlayColor, realtimeBorderRadius);
    }
    ...
    protected void drawBlurredBitmap(Canvas canvas, Bitmap blurredBitmap, int overlayColor,
        ...
        if (blurredBitmap != null) {
            ...
            matrix.postScale(mRectDst.width() / blurredBitmap.getWidth(),
                    mRectDst.height() / blurredBitmap.getHeight());
            shader.setLocalMatrix(matrix);
            mPaint.setShader(shader);
            canvas.drawRoundRect(mRectDst, realtimeBorderRadius, realtimeBorderRadius, mPaint);
